...
from e87canbus.sim_controller import SimulatorController, snapshot_event, snapshot_to_dict
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    uvicorn.run("e87canbus.sim_api:app", host=args.host, port=args.port, log_level=args.log_level)
    return 0
