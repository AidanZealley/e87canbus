...
from e87canbus import bench_pingpong
...
from e87canbus.sim_bus import InMemoryCanNetwork, SimulatedCanTraceEntry
from e87canbus.sim_devices import SimulatedNeoTrellisNode
...
class SimulatorController:
    ...
    def _route_pending_pi_frame(self, before_count: int) -> SimulatorSnapshot:
        while True:
            ...
            if frame is None:
                break
            bench_pingpong.handle_frame(self.pi_bus, frame, self.ids)
