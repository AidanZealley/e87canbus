...
| `0x701` | Coordinator to button pad | Incremental LED effect | 8 | byte 0 = command version, byte 1 = opcode, byte 2 = button index, byte 3 = sequence, byte 4 = pulses, byte 5 = red, byte 6 = green, byte 7 = blue |
