...
|---|---|---|---|---|---|
| Local browser SSE validation | Orchestrator and Aidan | After whole-feature closure, before completion | Testing | `9b5ba56f48c3ca431154c751014aa2f0ec6573d3` | Aidan reports every required browser check passed, or explicitly waives the gate |
