...
|---:|---|---|---|---|
| 1 | [CLI boundary and image build](01-cli-and-image-build.md) | Approved specs | Accepted | `3a1f0a2a0b65ae96b31d7be13281619408cbc7eb`; corrections `d0a22c191e8402602f299ec2b77006c9a59e400d`, `aa5f0f3280f987ce2ffd669120e677e3f2b8a405`; final CI coverage `3fa1571708c5e5027d848c15b54b7c08da5b75e6` |
| 2 | [Installation authority](02-installation-authority.md) | 1 accepted | Accepted | `11fae1dc10680678987d1db6fbfed03b921e2b1e`; final simplification `08700e459c90287273858b3c3caf0b5afcc0f577`; physical-verifier correction `f67e02e226491b7211c61ffd97bc73ce0c3a2792` |
| 3 | [Provisioning artifacts](03-provisioning-artifacts.md) | 2 accepted | Accepted | `fff702367bed156640f52085d6cc5c48ba196815`; corrections `924514ea061bb69a825efe19ebfec742c698bdf6`, `0f29317e2887975b29e218e653314bd83d8a8597`, `f67e02e226491b7211c61ffd97bc73ce0c3a2792`; final simplification `ee547ed57015d632764059c23a327547ed9afb45` |
| 4 | [Safe macOS card provisioning](04-macos-provisioning.md) | 3 accepted | Accepted | `3d01f300aee37d9cf0b3818143877083522c4374`; corrections `d93bf23afae5bbf1a3e8fed9ef16fe0ef454903e`, `2e29008c5d271fff3cc21fe9e3544f6ecead90b9`; final diagnostics `5c70dac02052bcd67085c7d94128c51fdf53cd30`; image-selection performance `1034e87222a1ac6d54835fbda34e9e0fa87c9621` |
| 5 | [Authenticated transport](05-authenticated-transport.md) | 3 accepted | Accepted | `d896b526f66765219db2718bef81efb888f3f72e` |
| 6 | [Provisionable host images](06-provisionable-images.md) | 4 and 5 accepted | Accepted | `3bac67b68a265b10508effced7930ae6c82beef7`; corrections `2e29008c5d271fff3cc21fe9e3544f6ecead90b9`, `9924947eacd209fc00b9eaa7fb0df5098c63892b`, `b944952b8672b601d11cb0f83feaf4c4ef4d4da4`, `3631bfcdf655f5af73162b3903fcccc9d197e166`, `8ed08b2152f4aaf93a64c4388604f853020f1e7a`, `ca6a8267201b3ef82fcf47030d2cefdb0761ac74`, `2827f7eaa2a69f5c1daf26910c4fe813a974b8e3`, `7a87845f15ba59d30ecd38772b985fa4ae0c34ca`, `417d4b47ba7746b8da5472bc364b230a29d0e5eb`, `06462fe30af212546f28f67d60b5d256d90b9243`, `f67e02e226491b7211c61ffd97bc73ce0c3a2792`; final failure-path bound `ee547ed57015d632764059c23a327547ed9afb45` |
...
| 9 | [Guided pair verification](09-guided-pair-verification.md) | 8 accepted and physical-verifier correction `f67e02e` | Accepted | Implementation `8205dbbba820d4b1ba8795407d8b45b8046aed2b`; formatting and accepted gate candidate `f8b8e02617375dff694c69976849a6eabe9fc804` |
...
| Provisioned pair | 9 | After workstream 9 closure | Passed | Clean image candidate and guided verifier `f8b8e02617375dff694c69976849a6eabe9fc804`; image provenance and final physical evidence recorded | Complete; Aidan accepted the explicit limitation that matching application and provisioning digest values were observed but not retained |
...
| 2026-09-14 | Use the single evidence-backed WPA2-Personal fallback with RSN only, CCMP only and required PMF. | Both iwd and wpa_supplicant failed SAE access-point operation on the target Pi 4 stack. The evidence isolates SAE, so the fallback retains `pmf=3`. It loses SAE forward secrecy and offline-guessing resistance, mitigated by the generated 32-character random PSK; TLS, mutual TLS, SSH, firewall and no-forwarding boundaries remain unchanged. | Aidan | 6-8 and provisioned-pair gate |
| 2026-09-14 | Resolve `firmware-brcm80211` from Debian for both Pi 4 roles. | A later rolling build regressed from a previously working Pi pair to a local brcmfmac status-16 association failure. Raspberry Pi's firmware tracker records the same low-level signature for its current package and recovery with Debian Trixie's package. The narrow source preference leaves the kernel, network owner and security profile unchanged. | Orchestrator, from physical evidence and upstream issue #58 | 6, 8 and provisioned-pair gate |
| 2026-09-15 | The console DSI display assembly, not the kernel or Wi-Fi firmware, causes the observed 2.4 GHz failure. Remove both diagnostic package overrides. | The authoritative disconnected/connected/disconnected ribbon test made the unchanged production profile join repeatedly on Trixie 6.18 with the ribbon absent, collapse the 2.4 GHz scan census with the display attached and recover after removal. The unchanged 5 GHz census is a control, but the split 5 GHz join test does not justify choosing 5 GHz as the fix. Commits `2827f7e` and `908f835` were reasonable diagnostic corrections from the evidence then available; their image behavior is now superseded while their history and reports remain. | Aidan, from physical DSI A/B/A evidence | 6, 8 and provisioned-pair gate |
| 2026-09-15 | Keep the custom authenticated nginx unit as the sole coordinator web boundary and verify its real listener. | Physical testing found the custom unit crash-looping on read-only default temp paths while Debian's stock unit exposed unauthenticated port 80; systemd's auto-restart state also fooled the checker. Moving all temp state under the existing runtime directory, masking the stock unit and checking the sockets restores the approved boundary without weakening its sandbox. The configured Claude call exhausted its quota, so the documented fresh in-session fallback performed and accepted the review. | Orchestrator, from physical gate evidence | 6, 8 and provisioned-pair gate |
| 2026-09-15 | Accept candidate `eda0d12` as passing the software and image gate; track the display spacer as hardware integration. | Fresh clean images provisioned successfully, both complete checkers passed, the console associated immediately when physically separated from the display and loaded settings through Chromium mutual TLS. The remaining interference is a mechanical proximity problem rather than a software or image defect. | Aidan | 7, 8 and provisioned-pair gate |
...
| 2026-09-15 | Accept Aidan's dedicated Claude session as workstream 9 implementation and review evidence. | Aidan delegated the whole workstream to Claude while other model usage was unavailable and confirmed that Claude completed its review. Do not spend more Claude quota repeating it. The record names the process substitution rather than claiming the configured separate read-only call ran. | Aidan | 9 |
| 2026-09-16 | Pass the provisioned-pair gate with an explicit digest-record limitation. | Clean `f8b8e02` image provenance, four passing guided checks, DHCP isolation and the required physical behaviors were recorded. Aidan confirmed that all application and provisioning digests matched during testing, but their literal values were lost with the closed diagnostic sessions, and approved closing the workflow on that evidence. | Aidan | 7-9 and provisioned-pair gate |
| 2026-09-16 | Accept the reopened whole-feature review and focused closure. | Claude found one unbounded invalid-bundle failure-path read and one dead helper. Separate owners corrected both; fresh Claude closure found no remaining required issue, and final verification passed. | Orchestrator | 3, 6 and whole-feature review |
