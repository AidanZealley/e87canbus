...
| Provisioned pair | 8 | After workstream 8 closure | Troubleshooting | `TBD` forward cleanup candidate; supersedes diagnostic candidates `2827f7eaa2a69f5c1daf26910c4fe813a974b8e3` and `908f835be7fd16b68c684782dedbf816de91e882` | Choose or implement a production display-interference mitigation, then build and repeat the complete clean-card procedure |
