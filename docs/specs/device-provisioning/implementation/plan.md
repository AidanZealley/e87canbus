...
| 9 | [Guided pair verification](09-guided-pair-verification.md) | 8 accepted and physical-verifier correction `f67e02e` | Closure review | Implementation `8205dbbba820d4b1ba8795407d8b45b8046aed2b`; formatting `f8b8e02617375dff694c69976849a6eabe9fc804`; acceptance awaits shared gate |
...
| Provisioned pair | 9 | After workstream 9 closure | Troubleshooting | Device correction `f67e02e226491b7211c61ffd97bc73ce0c3a2792`; guided verifier `f8b8e02617375dff694c69976849a6eabe9fc804`; guided report passed but exact image provenance is not recorded | Record the image build provenance and complete the outstanding workstream 7 and 8 physical evidence |
