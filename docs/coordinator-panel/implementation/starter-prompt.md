...
Status: ready to use after the approved documentation PR is merged into `main`.
...
Start from an up-to-date `main` containing these approved documents. Verify the worktree is clean,
then create a new branch named feature/coordinator-panel-implementation from `main` and record its
